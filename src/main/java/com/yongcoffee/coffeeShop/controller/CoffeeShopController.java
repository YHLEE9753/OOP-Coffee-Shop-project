...
public class CoffeeShopController {
    public static void main(String[] args) {
        ...
        Customer customer = new Customer(wallet, "Hoon Customer", cashier);
        ...
        customer.chooseCoffee(CoffeeType.AMERICANO, CoffeeSize.BIG, 5);
        customer.chooseCoffee(CoffeeType.LATTE, CoffeeSize.SMALL, 3);

        // 3. 주문을 하면 커피를 받는다.
        List<Order> orders = customer.makeOrder();
